 ...
 * \return int */
WINUX_FUNC_DECL(int) StrSplit( String const & str, String const & delimList, StringArray * arr );
...
/** \brief 使字符串大写 */
WINUX_FUNC_DECL(void) StrMakeUpper( String * str );
WINUX_FUNC_DECL(String) StrUpper( String const & str );
/** \brief 使字符串小写 */
WINUX_FUNC_DECL(void) StrMakeLower( String * str );
...
public:
    ...
    {
        typename _RetString::value_type * buf;
